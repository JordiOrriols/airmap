...
export default function RouteCard({ route, onDelete, startHref, editHref }: RouteCardProps) {
  ...
  return (
    <Card
      className="bg-card-app hover:bg-card-hover backdrop-blur-md border border-app-secondary rounded-3xl overflow-hidden hover:scale-[1.02] transition-all duration-300 shadow-card group"
