...
import { Navigation, CloudSun, Trash2, Download, Upload, Edit3, MousePointer, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <CollapsiblePanel title="Route Control" icon={Navigation} gradient="from-cyan-500 to-blue-500">
      <div className="space-y-4">
        ...
        <WaypointListPanel waypoints={waypoints} onRemove={removeWaypoint} onReorder={reorderWaypoints} />
      </div>
    </CollapsiblePanel>
  );
}
